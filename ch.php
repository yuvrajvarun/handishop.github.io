...
?>  <td> <a href="single.product.php?id=<?php  $data['PRODUCT_ID']; ?>"><center><img src="<?php  $datapc['PRODUCT_IMAGE'];?>" height="20px" width="10px"></center>
    <?php  $datapc['PRODUCT_DETAILS'];?> </a></td> 
     ...
     ?>
     <td><a href="product.deletec.php?id=<?php  $data['PRODUCT_ID']; ?>"><b>REMOVE</b></a></td>
</tr>
   
    <?php   
        } ?>
  <tr><td colspan="4">total cost:<?php  $TC; ?></td></tr>
<tr><td colspan="4">Place Order </td></tr>
    ...
    <label for="cost"  class="control-label">Total</label>
    <div class="col-lg-8">
    ...
    <div  class="form-control" class="col-lg-8">
     <div><input type="radio" name="pm" id="pm" >CARD</div> 
     <div><input type="radio" name="pm" id="pm" >NET BANKING</div>
     <div><input type="radio" name="pm" id="pm">UPI</div>
     <div><input type="radio" name="pm" id="pm">CASH ON DELEVIERY</div>
    </div>
    </div>
